...
class KnightStateSeeking_TeamA(State):
    ...
    def __init__(self, knight):
        ...
        self.knight.path_graph = self.knight.world.paths[2] #changed to middle lane
    ...
    def do_actions(self):
        ...
        if self.knight.velocity.length() > 0:
            # Stop knight from back to node before continuing
...
# =============================================================================
            #alternate movement strategy (faster) + MUST INCLUDE ALT PATHS IF SENT TO TOP OR BOTT LANES
                if self.knight.position[0] < 345: #check if x-axis of unit is past first checkpoint
                    ...
                    self.knight.move_target.position = (970,580) #not sure why, but this approach of ambushing outside the range of both towers seem to work better than charging in?
